...
require (
	...
	github.com/kweaver-ai/GoUtils v0.0.0-20220817070121-b89e2ee3b893
	github.com/kweaver-ai/TelemetrySDK-Go/exporter/v2 v2.9.1
	github.com/kweaver-ai/TelemetrySDK-Go/span/v2 v2.9.1
...
replace (
	github.com/kweaver-ai/GoUtils => ./GoUtils
