module github.com/kweaver-ai/go-lib
...
require (
	...
	github.com/kweaver-ai/TelemetrySDK-Go/exporter/v2 v2.0.0-00010101000000-000000000000
...
require (
	...
	github.com/kweaver-ai/proton-mq-sdk-go v1.8.2-for-ar-rm-cgo // indirect
