...
// WithCleanupRetentionTime sets the time that the cleanup process should start removing out of RetentionTime.
func WithCleanupRetentionTime(d time.Duration) Option {
	return func(o *Outboxer) {
		o.cleanUpRetentionTime = d
	}
}

// WithCleanupBatchSize sets the cleanup process batch size.
