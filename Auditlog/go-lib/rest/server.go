...
var (
	strCodeToInt = map[string]int{
		errorv2.BadRequest:          400,
		errorv2.Unauthorized:        401,
		errorv2.Forbidden:           403,
		errorv2.NotFound:            404,
		errorv2.Conflict:            409,
		errorv2.InternalServerError: 500,
		errorv2.ServiceUnavailable:  503,
	}
)
...
func ReplyError(c *gin.Context, err error) {
	...
	case *errorv2.Error:
		...
		statusCode = strCodeToInt[strCode]
		body = e.Error()
	default:
