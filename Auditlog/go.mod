...
require (
	...
	github.com/go-playground/validator/v10 v10.26.1-0.20250416212006-c3fc72e18236
	...
	github.com/kweaver-ai/TelemetrySDK-Go/exporter/v2 v2.9.3
	github.com/kweaver-ai/TelemetrySDK-Go/span/v2 v2.9.3
	...
	github.com/kweaver-ai/proton_dm_dialect_go v0.0.0-20230615061324-afded188ccb9
...
replace (
	...
	github.com/kweaver-ai/proton_dm_dialect_go => ./proton_dm_dialect_go
)
...
require (
	...
	github.com/kweaver-ai/TelemetrySDK-Go/event/v2 v2.9.3 // indirect
