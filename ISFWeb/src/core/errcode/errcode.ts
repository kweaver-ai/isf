...
const ErrorKeyHash = {
    ...
    [ErrorCode.DomainServerUnavailable]: '连接LDAP服务器失败，请检查域控ip是否正确，或者域控制器是否开启！',
    ...
    [ErrorCode.UserNotFound]: '该用户未导入到系统中',
    ...
    [ErrorCode.ApplyAuditMissing]: '当前无匹配的审核员，本次操作无法生效，请联系管理员。',
    ...
    [ErrorCode.PersonalInvitationUnauthorized]: '您没有共享个人文档库的权限，无法开启共享邀请。',
    [ErrorCode.GroupInvitationUnauthorized]: '您没有共享群组文档库的权限，无法开启共享邀请。',
    [ErrorCode.PersonLinkUnauthorized]: '您没有共享个人文档库的权限，无法开启HTTPLink。',
    [ErrorCode.GroupLinkUnauthorized]: '您没有共享群组文档库的权限，无法开启HTTPLink。',
    [ErrorCode.PersonLinkModificationUnauthorized]: '您没有共享个人文档库的权限，无法修改HTTP共享。',
    [ErrorCode.GroupLinkModificationUnathorized]: '您没有共享群组文档库的权限，无法修改HTTP共享。',
    [ErrorCode.PersonalInvitationModificationUnauthorized]: '您没有共享个人文档库的权限，无法修改共享邀请。',
    [ErrorCode.GroupInvitationModificationUnauthorized]: '您没有共享群组文档库的权限，无法修改共享邀请。',
    ...
    [ErrorCode.EmailInvalid]: '邮箱地址只能包含 英文、数字 及 @-_. 字符，格式形如 XXX@XXX.XXX，长度范围 5~100 个字符，请重新输入。',
    ...
    [ErrorCode.WorkFlowCommentsOverWords]: '审核流程失败，补充说明不能超过1024个字节。',
    ...
    [ErrorCode.DisplayNameInvalid]: '显示名不合法，可能字符过长或包含 \\ / : * ? " < > | 特殊字符，请重新输入。',
    [ErrorCode.DisplayNameDuplicated]: '该显示名已被占用，请重新输入。',
    [ErrorCode.ThirdPartyValidateFail]: '第三方验证失败，请检查第三方服务器是否开启!',
    [ErrorCode.AttrNotExist]: '无法执行此操作，可能某个编目已被管理员删除。',
    [ErrorCode.PhoneNotUnbound]: '管理员已开启短信身份验证，您尚未绑定手机，无法发送验证码，请联系管理员。',
    [ErrorCode.SMSServerExceptions]: '管理员已开启短信身份验证，但短信服务器异常，无法发送验证码，请联系管理员。',
    [ErrorCode.SMSServerNotEnabled]: '发送失败，可能短信服务器未正常启用，请联系管理员。',
    ...
    [ErrorCode.PhoneModified]: '发送失败，您绑定的手机号发生变更，请返回登录重试。',
