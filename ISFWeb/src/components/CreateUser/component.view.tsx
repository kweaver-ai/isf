...
import { Button, Form, Text, UIIcon } from '@/ui/ui.desktop';
...
import CreateUserBase from './component.base';
...
export default class CreateUserMain extends CreateUserBase {

    render() {
        const { showAddDialog, showAddDirectSupervisorDialog, managerInfo, userInfo: { loginName, displayName, code, position, remark, email, telNumber, idcardNumber, csfLevel, expireTime, show_csf_level2, csfLevel2 }, validateState, csfOptions, csfOptions2 } = this.state;
                    ...
                    showAddDialog ?
                        ...
                        >
                            <Form role={'ui-form'}>
                                <Form.Row role={'ui-form.row'}>
                                    ...
                                    <Form.Field role={'ui-form.field'}>
                                        <ValidateBox
                                            ...
                                            validateState={validateState.loginName}
                                            onBlur={() => this.handleOnBlur(Type.LoginName)}
                                            onValueChange={({ detail }) => this.handleValueChange({ loginName: detail })}
                                        />
                                    </Form.Field>
                                </Form.Row>
                                <Form.Row role={'ui-form.row'}>
                                ...
                                <Form.Row role={'ui-form.row'}>
                                    <Form.Label className={styles['text-label']}>
                                        {
                                            __('直属部门：')
                                        }
                                    </Form.Label>
                                ...
                                <Form.Row role={'ui-form.row'}>
                                    ...
                                    <Form.Field role={'ui-form.field'}>
                                        <ValidateBox
                                            ...
                                            disabled={false}
                                            validateMessages={ValidateMessages}
                                            validateState={validateState.telNumber}
                                            onBlur={() => this.handleOnBlur(Type.TelNumber)}
                                            onValueChange={({ detail }) => this.handleValueChange({ telNumber: detail })}
                                        />
                                    </Form.Field>
                                </Form.Row>
                                <Form.Row role={'ui-form.row'}>
                                    ...
                                    <Form.Field role={'ui-form.field'}>
                                        <ValidateBox
                                            ...
                                            disabled={false}
                                            validateMessages={ValidateMessages}
                                            validateState={validateState.idcardNumber}
                                            onBlur={() => this.handleOnBlur(Type.IdcardNumber)}
                                            onValueChange={({ detail }) => this.handleValueChange({ idcardNumber: detail })}
                                        />
                                    </Form.Field>
                                </Form.Row>
                                <Form.Row role={'ui-form.row'}>
