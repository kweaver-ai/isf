...
replace (
	github.com/gobuffalo/pop/v6 => ./proton_gobuffalo_pop
	github.com/kweaver-ai/proton-rds-sdk-go => ./proton-rds-sdk-go
	github.com/ory/x => ./proton_ory_x
)
...
require (
	...
	github.com/kweaver-ai/proton-rds-sdk-go v0.0.0-00010101000000-000000000000 // indirect
